...
main:
; Operação de subtração: 1024 - 512
    LDI r24, 0
    LDI r25, 100
    LDI r22, 0
    LDI r23, 96
    ...
    STS results+1, r25
    RCALL print_f16
; Operação de multiplicação: 0.125 * 8
    LDI r24, 0
    LDI r25, 48
    LDI r22, 0
    LDI r23, 72
...
; Operação de resultado N linhas atrás: 3 RES
    ...
    STS T6_L, r24
    STS T6_H, r25
; Operação de escrever valor na memória: T6 MEM
    LDS r24, T6_L
    LDS r25, T6_H
    RCALL set_mem
    STS T7_L, r24
    ...
    STS results+7, r25
    RCALL print_f16
; Operação de divisão real: 16 | 0.5
    LDI r24, 0
    LDI r25, 76
    LDI r22, 0
    LDI r23, 56
...
; Operação de resultado N linhas atrás: 1 RES
    ...
    STS T10_L, r24
    STS T10_H, r25
; Operação de divisão inteira: T9 / T10
    LDS r24, T9_L
    LDS r25, T9_H
    LDS r22, T10_L
    LDS r23, T10_H
...
; Operação de resto: -80.5 % 7
    ...
    STS results+15, r25
    RCALL print_f16
; Operação de resultado N linhas atrás: 6 RES
    LDI r24, 2
    RCALL res_op
    STS T16_L, r24
    STS T16_H, r25
; Operação de resultado N linhas atrás: 8 RES
    LDI r24, 0
    RCALL res_op
    STS T17_L, r24
    STS T17_H, r25
; Operação de subtração: T16 - T17
    LDS r24, T16_L
    LDS r25, T16_H
    LDS r22, T17_L
    LDS r23, T17_H
...
; Operação de resultado N linhas atrás: 1 RES
    ...
    STS T19_L, r24
    STS T19_H, r25
; Operação de escrever valor na memória: T19 MEM
    LDS r24, T19_L
    LDS r25, T19_H
    RCALL set_mem
    STS T20_L, r24
    ...
    STS results+19, r25
    RCALL print_f16
; Operação de resultado N linhas atrás: 7 RES
    LDI r24, 3
    RCALL res_op
    STS T21_L, r24
    STS T21_H, r25
; Operação de adição: T21 + 0.125
    LDS r24, T21_L
    LDS r25, T21_H
    LDI r22, 0
    LDI r23, 48
...
; Operação de resultado N linhas atrás: 3 RES
    ...
    STS T27_L, r24
    STS T27_H, r25
; Operação de multiplicação: T26 * T27
    LDS r24, T26_L
    LDS r25, T26_H
    LDS r22, T27_L
    LDS r23, T27_H
    ...
    STS results+25, r25
    RCALL print_f16
; Operação de divisão real: 0.125 | 1000
    LDI r24, 0
    LDI r25, 48
    LDI r22, 208
    LDI r23, 99
