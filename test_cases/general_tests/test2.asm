...
; Operação de resultado N linhas atrás: 1 RES
    ...
    STS T2_L, r24
    STS T2_H, r25
; Operação de escrever valor na memória: T2 MEM
    LDS r24, T2_L
    LDS r25, T2_H
    RCALL set_mem
    STS T3_L, r24
...
; Operação de resultado N linhas atrás: 2 RES
    ...
    STS T4_L, r24
    STS T4_H, r25
; Operação de divisão inteira: 50 / T4
    LDI r24, 64
    LDI r25, 82
    LDS r22, T4_L
    LDS r23, T4_H
...
; Operação de adição: T6 + T7
    ...
    STS results+7, r25
    RCALL print_f16
; Operação de divisão real: 1000 | 6.25
    LDI r24, 208
    LDI r25, 99
    LDI r22, 64
    LDI r23, 70
    ...
    STS T9_L, r24
    STS T9_H, r25
; Operação de escrever valor na memória: T9 MEM
    LDS r24, T9_L
    LDS r25, T9_H
    RCALL set_mem
    STS T10_L, r24
...
; Operação de resultado N linhas atrás: 2 RES
    ...
    STS T14_L, r24
    STS T14_H, r25
; Operação de multiplicação: T13 * T14
    LDS r24, T13_L
    LDS r25, T13_H
    LDS r22, T14_L
    LDS r23, T14_H
    ...
    STS results+11, r25
    RCALL print_f16
; Operação de multiplicação: 0.25 * 0.5
    LDI r24, 0
    LDI r25, 52
    LDI r22, 0
    LDI r23, 56
...
; Operação de resultado N linhas atrás: 1 RES
    ...
    STS T17_L, r24
    STS T17_H, r25
; Operação de multiplicação: 1000 * T17
    LDI r24, 208
    LDI r25, 99
    LDS r22, T17_L
    LDS r23, T17_H
...
; Operação de resultado N linhas atrás: 7 RES
    ...
    STS T19_L, r24
    STS T19_H, r25
; Operação de divisão real: 1 | T19
    LDI r24, 0
    LDI r25, 60
    LDS r22, T19_L
    LDS r23, T19_H
...
; Operação de resultado N linhas atrás: 1 RES
    ...
    STS T25_L, r24
    STS T25_H, r25
; Operação de escrever valor na memória: T25 MEM
    LDS r24, T25_L
    LDS r25, T25_H
    RCALL set_mem
    STS T26_L, r24
