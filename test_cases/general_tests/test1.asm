...
; Operação de resultado N linhas atrás: 1 RES
    ...
    STS T2_L, r24
    STS T2_H, r25
; Operação de multiplicação: T2 * -40
    LDS r24, T2_L
    LDS r25, T2_H
    LDI r22, 0
    LDI r23, 209
    ...
    STS results+3, r25
    RCALL print_f16
; Operação de resultado N linhas atrás: 2 RES
    LDI r24, 0
    RCALL res_op
    STS T4_L, r24
    STS T4_H, r25
; Operação de divisão inteira: T4 / 15
    LDS r24, T4_L
    LDS r25, T4_H
    LDI r22, 128
    LDI r23, 75
    ...
    STS results+5, r25
    RCALL print_f16
; Operação de resultado N linhas atrás: 3 RES
    LDI r24, 0
    RCALL res_op
    STS T6_L, r24
    STS T6_H, r25
; Operação de divisão real: T6 | 3
    LDS r24, T6_L
    LDS r25, T6_H
    LDI r22, 0
    LDI r23, 66
    ...
    STS results+7, r25
    RCALL print_f16
; Operação de resultado N linhas atrás: 4 RES
    LDI r24, 0
    RCALL res_op
    STS T8_L, r24
    STS T8_H, r25
; Operação de escrever valor na memória: T8 MEM
    LDS r24, T8_L
    LDS r25, T8_H
    RCALL set_mem
    STS T9_L, r24
...
; Operação de ler valor da memória
    ...
    STS T12_L, r24
    STS T12_H, r25
; Operação de divisão real: T11 | T12
    LDS r24, T11_L
    LDS r25, T11_H
    LDS r22, T12_L
    LDS r23, T12_H
    ...
    STS results+11, r25
    RCALL print_f16
; Operação de multiplicação: -234.5 * 12.25
    LDI r24, 84
    LDI r25, 219
    LDI r22, 32
    LDI r23, 74
    ...
    STS results+13, r25
    RCALL print_f16
; Operação de divisão inteira: 10 / 3
    LDI r24, 0
    LDI r25, 73
    LDI r22, 0
    LDI r23, 66
...
; Operação de adição: 5.5 + 4.5
    ...
    STS T18_L, r24
    STS T18_H, r25
; Operação de escrever valor na memória: T18 MEM
    LDS r24, T18_L
    LDS r25, T18_H
    RCALL set_mem
    STS T19_L, r24
...
; Operação de resultado N linhas atrás: 3 RES
    ...
    STS T23_L, r24
    STS T23_H, r25
; Operação de multiplicação: T22 * T23
    LDS r24, T22_L
    LDS r25, T22_H
    LDS r22, T23_L
    LDS r23, T23_H
    ...
    STS results+21, r25
    RCALL print_f16
; Operação de divisão inteira: 6 / 2
    LDI r24, 0
    LDI r25, 70
    LDI r22, 0
    LDI r23, 64
...
; Operação de subtração: T25 - T26
    ...
    STS results+23, r25
    RCALL print_f16
; Operação de multiplicação: 3.125 * 2.0
    LDI r24, 64
    LDI r25, 66
    LDI r22, 0
    LDI r23, 64
...
; Operação de subtração: 5 - 1
    ...
    STS T29_L, r24
    STS T29_H, r25
; Operação de divisão inteira: T28 / T29
    LDS r24, T28_L
    LDS r25, T28_H
    LDS r22, T29_L
    LDS r23, T29_H
