...
; Operação de divisão inteira: 10 / 3
    ...
    STS results+3, r25
    RCALL print_f16
; Operação de divisão inteira: 10 / 5
    LDI r24, 0
    LDI r25, 73
    LDI r22, 0
    LDI r23, 69
    ...
    STS results+5, r25
    RCALL print_f16
; Operação de divisão inteira: 7 / 3
    LDI r24, 0
    LDI r25, 71
    LDI r22, 0
    LDI r23, 66
    ...
    STS results+7, r25
    RCALL print_f16
; Operação de divisão inteira: 1 / 2
    LDI r24, 0
    LDI r25, 60
    LDI r22, 0
    LDI r23, 64
...
; Operação de divisão inteira: -7 / 3
    ...
    STS results+17, r25
    RCALL print_f16
; Operação de divisão inteira: 0 / 5
    LDI r24, 0
    LDI r25, 0
    LDI r22, 0
    LDI r23, 69
...
; Operação de divisão inteira: 0 / -5
    ...
    STS results+21, r25
    RCALL print_f16
; Operação de divisão inteira: 10 / 0
    LDI r24, 0
    LDI r25, 73
    LDI r22, 0
    LDI r23, 0
...
; Operação de divisão inteira: -10 / 0
    ...
    STS results+25, r25
    RCALL print_f16
; Operação de divisão inteira: 0 / 0
    LDI r24, 0
    LDI r25, 0
    LDI r22, 0
    LDI r23, 0
    ...
    STS results+27, r25
    RCALL print_f16
; Operação de divisão inteira: 80 / 15
    LDI r24, 0
    LDI r25, 85
    LDI r22, 128
    LDI r23, 75
...
; Operação de divisão inteira: -80 / 15
    ...
    STS results+31, r25
    RCALL print_f16
; Operação de divisão inteira: 65504 / 2
    LDI r24, 255
    LDI r25, 123
    LDI r22, 0
    LDI r23, 64
    ...
    STS results+33, r25
    RCALL print_f16
; Operação de divisão inteira: 65504 / 1
    LDI r24, 255
    LDI r25, 123
    LDI r22, 0
    LDI r23, 60
...
; Operação de divisão inteira: -1 / 2
    ...
    STS results+37, r25
    RCALL print_f16
; Operação de divisão inteira: 0.9 / 1
    LDI r24, 51
    LDI r25, 59
    LDI r22, 0
    LDI r23, 60
