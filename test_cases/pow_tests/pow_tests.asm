...
; Operação de potenciação: -2 ^ 16
    ...
    STS results+51, r25
    RCALL print_f16
; Operação de potenciação: 0.5 ^ 14
    LDI r24, 0
    LDI r25, 56
    LDI r22, 0
    LDI r23, 75
    ...
    STS results+53, r25
    RCALL print_f16
; Operação de potenciação: 0.5 ^ 15
    LDI r24, 0
    LDI r25, 56
    LDI r22, 128
    LDI r23, 75
    ...
    STS results+55, r25
    RCALL print_f16
; Operação de potenciação: 0.5 ^ 100
    LDI r24, 0
    LDI r25, 56
    LDI r22, 64
    LDI r23, 86
...
; Operação de potenciação: 2 ^ 30
    ...
    STS results+63, r25
    RCALL print_f16
; Operação de potenciação: 1.1 ^ 30
    LDI r24, 102
    LDI r25, 60
    LDI r22, 128
    LDI r23, 79
