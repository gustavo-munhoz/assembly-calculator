...
; Operação de multiplicação: 3 * 3
    ...
    STS results+1, r25
    RCALL print_f16
; Operação de multiplicação: 2 * 40
    LDI r24, 0
    LDI r25, 64
    LDI r22, 0
    LDI r23, 81
    ...
    STS results+3, r25
    RCALL print_f16
; Operação de multiplicação: 10 * 0.5
    LDI r24, 0
    LDI r25, 73
    LDI r22, 0
    LDI r23, 56
    ...
    STS results+5, r25
    RCALL print_f16
; Operação de multiplicação: 0.5 * 0.5
    LDI r24, 0
    LDI r25, 56
    LDI r22, 0
    LDI r23, 56
...
; Operação de multiplicação: -4 * -5
    ...
    STS results+11, r25
    RCALL print_f16
; Operação de multiplicação: 100 * 0
    LDI r24, 64
    LDI r25, 86
    LDI r22, 0
    LDI r23, 0
    ...
    STS results+13, r25
    RCALL print_f16
; Operação de multiplicação: 0 * -20
    LDI r24, 0
    LDI r25, 0
    LDI r22, 0
    LDI r23, 205
...
; Operação de multiplicação: 0 * 0
    ...
    STS results+17, r25
    RCALL print_f16
; Operação de multiplicação: 12.5 * 1
    LDI r24, 64
    LDI r25, 74
    LDI r22, 0
    LDI r23, 60
...
; Operação de multiplicação: 12.5 * -1
    ...
    STS results+21, r25
    RCALL print_f16
; Operação de multiplicação: 512 * 256
    LDI r24, 0
    LDI r25, 96
    LDI r22, 0
    LDI r23, 92
    ...
    STS results+23, r25
    RCALL print_f16
; Operação de multiplicação: 1000 * 100
    LDI r24, 208
    LDI r25, 99
    LDI r22, 64
    LDI r23, 86
...
; Operação de multiplicação: -1000 * -100
    ...
    STS results+29, r25
    RCALL print_f16
; Operação de multiplicação: 600 * 600
    LDI r24, 176
    LDI r25, 96
    LDI r22, 176
    LDI r23, 96
    ...
    STS results+31, r25
    RCALL print_f16
; Operação de multiplicação: 0.5 * 0.00006103515625
    LDI r24, 0
    LDI r25, 56
    LDI r22, 0
    LDI r23, 4
    ...
    STS results+33, r25
    RCALL print_f16
; Operação de multiplicação: 0.0001220703125 * 0.0001220703125
    LDI r24, 0
    LDI r25, 8
    LDI r22, 0
    LDI r23, 8
    ...
    STS results+35, r25
    RCALL print_f16
; Operação de multiplicação: 0.0078125 * 0.0078125
    LDI r24, 0
    LDI r25, 32
    LDI r22, 0
    LDI r23, 32
    ...
    STS results+37, r25
    RCALL print_f16
; Operação de multiplicação: 0.00048828125 * 0.00048828125
    LDI r24, 0
    LDI r25, 16
    LDI r22, 0
    LDI r23, 16
