...
; Operação de divisão real: 0 | -1
    ...
    STS results+25, r25
    RCALL print_f16
; Operação de divisão real: 12.5 | 1
    LDI r24, 64
    LDI r25, 74
    LDI r22, 0
    LDI r23, 60
...
; Operação de divisão real: 12.5 | -1
    ...
    STS results+29, r25
    RCALL print_f16
; Operação de divisão real: 1000 | 0.01
    LDI r24, 208
    LDI r25, 99
    LDI r22, 31
    LDI r23, 33
    ...
    STS results+31, r25
    RCALL print_f16
; Operação de divisão real: 1 | 0.000000059604644775390625
    LDI r24, 0
    LDI r25, 60
    LDI r22, 0
    LDI r23, 0
    ...
    STS results+33, r25
    RCALL print_f16
; Operação de divisão real: 0.00006103515625 | 2
    LDI r24, 0
    LDI r25, 4
    LDI r22, 0
    LDI r23, 64
    ...
    STS results+35, r25
    RCALL print_f16
; Operação de divisão real: 0.000000059604644775390625 | 2
    LDI r24, 0
    LDI r25, 0
    LDI r22, 0
    LDI r23, 64
    ...
    STS results+37, r25
    RCALL print_f16
; Operação de divisão real: 80 | 15
    LDI r24, 0
    LDI r25, 85
    LDI r22, 128
    LDI r23, 75
