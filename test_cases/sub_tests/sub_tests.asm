...
; Operação de subtração: 0 - 0
    ...
    STS results+25, r25
    RCALL print_f16
; Operação de subtração: 60000 - -6000
    LDI r24, 83
    LDI r25, 123
    LDI r22, 220
    LDI r23, 237
...
; Operação de subtração: -60000 - 6000
    ...
    STS results+29, r25
    RCALL print_f16
; Operação de subtração: 0.00006103515625 - 0.000000059604644775390625
    LDI r24, 0
    LDI r25, 4
    LDI r22, 0
    LDI r23, 0
    ...
    STS results+31, r25
    RCALL print_f16
; Operação de subtração: 0.000061094760894775390625 - 0.00006103515625
    LDI r24, 1
    LDI r25, 4
    LDI r22, 0
    LDI r23, 4
    ...
    STS results+33, r25
    RCALL print_f16
; Operação de subtração: 0.000000001 - 0
    LDI r24, 0
    LDI r25, 0
    LDI r22, 0
    LDI r23, 0
    ...
    STS results+35, r25
    RCALL print_f16
; Operação de subtração: 0 - 0.000000001
    LDI r24, 0
    LDI r25, 0
    LDI r22, 0
    LDI r23, 0
